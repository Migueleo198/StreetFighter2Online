...
export class Ken extends Sprite {
    constructor(x, y, imageSrc, velocity, playerId,onAttackHit) {
        super(728, STAGE_FLOOR, "./assets/spriteSheets/Arcade - Street Fighter 2 Super Street Fighter 2 - Ken.png", FighterDirection.RIGHT, 1,onAttackHit);
        ...
        this.frames = new Map([
            ...
            // HEAVY PUNCH
            ['heavy-punch-1', [[173, 1509, 108, 94], PushBox.IDLE, HurtBox.PUNCH]],
     ...
     // Override update method to hold the last frame of MEDIUM_PUNCH while the punch button remains held.
        ...
        draw(renderer, camera) {
            ...
            if ( this.currentState === FighterState.LIGHT_KICK  || this.currentState === FighterState.MEDIUM_PUNCH ||  this.currentState === FighterState.HEAVY_PUNCH) {
